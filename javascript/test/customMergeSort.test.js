const customMergeSort = require('../algorithms/customMergeSort');

describe('customMergeSort', () => {
  test('should return an empty array if passed an empty array', () => {
    const arr = [];

    expect(customMergeSort(arr)).toEqual([]);
  });

  test('should return the same array if array length of 1', () => {
    const arr = [1];

    expect(customMergeSort(arr)).toEqual([1]);
  });

  test('should correctly sort a shuffled array of 2 elements', () => {
    const arr = [2, 1];

    expect(customMergeSort(arr)).toEqual([1, 2]);
  });

  test('should correctly sort a shuffled array of 3 elements', () => {
    const arr = [2, 1, 3];

    expect(customMergeSort(arr)).toEqual([1, 2, 3]);
  });
